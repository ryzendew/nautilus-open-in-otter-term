...
arch=('any')
url="https://github.com/matt/nautilus-open-in-otter-term"
license=('GPL3')
depends=('python-nautilus>=4.0')
makedepends=('git')

source=("$pkgname-latest.tar.gz::https://github.com/matt/nautilus-open-in-otter-term/archive/refs/heads/main.tar.gz")
